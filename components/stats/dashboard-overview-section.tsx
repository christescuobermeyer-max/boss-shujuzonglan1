      ...
      <section className="overview-grid">
        ...
        <div className="column-stack">
          ...
          <ChartPanel title="本月每日开单趋势" subtitle="按签约日期查看当月开单变化">
            <BarChart data={props.dailyOrderData} height={MIDDLE_BAR_PANEL_HEIGHT} showAverageLine />
          </ChartPanel>
          <ChartPanel title="销售业绩分布" subtitle="各销售当月开单店铺数量">
            <BarChart data={props.salesDistributionData} height={MIDDLE_BAR_PANEL_HEIGHT} showAverageLine />
          </ChartPanel>
          <div
            ref={wuhanStripRef}
            style={wuhanStripMinHeight ? { minHeight: `${wuhanStripMinHeight}px` } : undefined}
          >
            <WuhanOpenedPointStrip summary={props.wuhanMonthlyPointSummary} />
          </div>
        </div>
